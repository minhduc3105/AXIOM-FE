      ...
      <div className="grid items-start gap-5 lg:grid-cols-2">
        <Card>
          <CardHeader className="border-b">
            ...
            <p className="text-sm text-muted-foreground">
              People who can manage organization access.
            </p>
          </CardHeader>
          {loading ? (
                ...
                >
                  <Avatar className="size-8 shrink-0">
                    <AvatarFallback className="bg-muted text-xs font-semibold text-primary">
                      {initials(
                        administrator.display_name || administrator.email,
                      )}
                    </AvatarFallback>
                  </Avatar>
                  <div className="min-w-0">
            ...
            <Empty
              ...
              title="No administrators returned"
              detail="Refresh the page or review organization members."
            />
          )}
        </Card>
        <Card>
          <CardHeader className="border-b">
            ...
            <p className="text-sm text-muted-foreground">
              Access and setup checks that require action.
            </p>
          </CardHeader>
          {loading ? (
            <CardContent className="grid gap-2 pt-5">
            ...
            <CardContent className="py-5">
              <p className="text-sm font-medium">No issues need attention</p>
              <p className="mt-1 text-xs text-muted-foreground">
                Members, workspaces, and administrator coverage are set up.
              </p>
            </CardContent>
          )}
        </Card>
    ...
    <Card>
      ...
      <CardContent className="pt-5">
        <dl className="grid gap-3 text-sm">
          ...
          <Summary label="Organization ID" value={organizationId} technical />
