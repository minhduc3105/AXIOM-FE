...
export function ReportsPage({
  ...
  return (
    <section className="relative min-h-[calc(100dvh-var(--app-top-bar-height))] px-5 pb-12 pt-4 sm:px-8 md:pt-6">
      <div className="pointer-events-none absolute inset-x-0 top-0 -z-10 h-[520px] bg-[radial-gradient(circle_at_78%_8%,rgba(36,86,232,0.12),transparent_34%),radial-gradient(circle_at_10%_38%,rgba(120,75,18,0.10),transparent_36%)]" />
      <div className="mx-auto grid w-full max-w-[1240px] gap-6">
        <header className="rounded-[28px] border border-[#d8d0c2]/80 bg-[#fffdf8]/88 p-5 shadow-[0_24px_70px_rgba(24,24,18,0.09)] backdrop-blur-xl dark:border-[#38372f]/80 dark:bg-[#1a1a17]/88 sm:p-7">
          <div className="flex flex-col gap-5 lg:flex-row lg:items-start lg:justify-between">
            <div>
              <span className="rounded-full border border-[#2456e8]/30 bg-[#edf2ff] px-2.5 py-1 text-xs font-semibold text-[#1237b4] dark:bg-[#7895ff]/12 dark:text-[#bcc9ff]">
            ...
            <div className="flex flex-wrap gap-2">
              ...
              <Button
                className="rounded-full bg-[#2456e8] text-white hover:bg-[#1d48c7]"
        ...
        {!workspaceId ? (
          <div className="rounded-[24px] border border-dashed border-[#d8d0c2] bg-[#fffdf8]/70 p-8 text-center text-[#625d53] dark:border-[#38372f] dark:bg-[#1a1a17]/70 dark:text-[#c5bcaf]">
            Select a workspace to configure and view its reports.
          </div>
        ) : (
          <>
            <section className="grid gap-4 lg:grid-cols-[1.2fr_.8fr]">
              <div className="rounded-[24px] border border-[#d8d0c2]/80 bg-[#fffdf8]/88 p-5 shadow-[0_14px_44px_rgba(24,24,18,0.06)] dark:border-[#38372f] dark:bg-[#1a1a17]/88">
                ...
                <p className="mt-4 flex items-center gap-2 text-xs text-[#6d685e] dark:text-[#aaa397]">
                  <Clock3Icon className="size-3.5" /> Next check:{" "}
                  {formatDate(policy?.next_due_at ?? null)}
                </p>
              </div>
              <div className="rounded-[24px] border border-[#d8d0c2]/80 bg-[#f4efe5]/72 p-5 dark:border-[#38372f] dark:bg-white/5">
                <p className="text-xs text-[#6d685e] dark:text-[#aaa397]">
            ...
            <section className="rounded-[24px] border border-[#d8d0c2]/80 bg-[#fffdf8]/88 p-5 shadow-[0_14px_44px_rgba(24,24,18,0.06)] dark:border-[#38372f] dark:bg-[#1a1a17]/88">
              ...
              <div className="mt-4 grid gap-3">
                {!loading && reports.length === 0 && (
                  <p className="py-8 text-center text-sm text-[#625d53] dark:text-[#c5bcaf]">
                ...
                {reports.map((report) => (
                  <article
                    ...
                    className="rounded-[18px] border border-[#d8d0c2]/80 p-4 dark:border-[#38372f]"
                  >
            ...
            {selected && (
              <section className="rounded-[24px] border border-[#2456e8]/30 bg-[#edf2ff]/55 p-5 dark:bg-[#7895ff]/8">
                ...
                <ul className="mt-4 grid gap-2">
                  {selected.sources.map((source) => (
                    <li
                      ...
                      className="flex items-center justify-between gap-3 rounded-xl border border-[#d8d0c2]/80 bg-white/75 px-3 py-2 text-sm dark:border-[#38372f] dark:bg-[#1a1a17]/75"
                    >
                      <span className="min-w-0 truncate">
                        <FileTextIcon className="mr-2 inline size-4 text-[#2456e8]" />
                        {source.filename}
                      </span>
                      <span className="shrink-0 rounded-full bg-[#f4efe5] px-2 py-0.5 text-xs dark:bg-white/10">
                        {source.role}
                      </span>
                    </li>
                  ))}
