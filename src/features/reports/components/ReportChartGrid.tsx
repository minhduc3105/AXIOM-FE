  ...
  return (
    <section className="grid gap-3" aria-labelledby="report-charts-heading">
      <div className="flex items-end justify-between gap-3">
        <div>
          <h2 id="report-charts-heading" className="mt-1 text-xl font-semibold">
            Charts
          </h2>
        </div>
      </div>
        ...
        <Card className="border-dashed bg-card/70">
          <Empty className="min-h-40">
            <EmptyHeader>
              ...
              <EmptyDescription>
                Charts appear when the latest report includes finite,
                evidence-backed data points.
              </EmptyDescription>
            </EmptyHeader>
          </Empty>
        </Card>
...
function ChartCard({
  ...
  chart: ReportDashboardSnapshot["charts"][number];
}) {
  ...
  return (
    <Card className="min-w-0 border-border/80 bg-card">
      <CardHeader>
        <CardTitle className="truncate" title={chart.title}>
          {chart.title}
        </CardTitle>
        {chart.description && (
